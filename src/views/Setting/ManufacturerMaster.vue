...
<div class="flex justify-between">
  ...
  <div class="flex gap-10">
    ...
    <div class="button-wrapper">
      <Button type="button" class="filled__blue" label="Add New Manufacturer" @click="newModalToggle" />
    </div>
  </div>
</div>
...
import { useMasterDataStore } from '@/stores/MasterDataStore'
  ...
  onBeforeMount( async () => {
    await masterDataStore.getManufacturers()
    // manufacturers.value = masterDataStore.manufacturers
    console.log(masterDataStore.manufacturers)
  })
