...
.input-wrapper {
  @apply 
    flex flex-row items-center bg-white p-2 pl-4 hover:bg-[#eef3f7] transition-colors duration-300 h-[50px] w-full
}
...
.outlined {
  @apply
  border-solid border-t border-x rounded-t-[20px]  border-[#EBEBED]
}
